...
then
    ...
    mv -v Menu-du-mois-de-2022-10.pdf $FILE && echo -e "${BGreen}V.10 ERFOLGREICH${NC}" && echo
fi
...
then
    ...
    mv -v Menu-du-mois-de-2022-9.pdf $FILE && echo -e "${BGreen}V.9 ERFOLGREICH${NC}" && echo
fi
...
then
    ...
    mv -v Menu-du-mois-de-2022-8.pdf $FILE && echo -e "${BGreen}V.8 ERFOLGREICH${NC}" && echo
fi
...
then
    ...
    mv -v Menu-du-mois-de-2022-7.pdf $FILE && echo -e "${BGreen}V.7 ERFOLGREICH${NC}" && echo
fi
...
then
    ...
    mv -v Menu-du-mois-de-2022-6.pdf $FILE && echo -e "${BGreen}V.6 ERFOLGREICH${NC}" && echo
fi
...
then
    ...
    mv -v Menu-du-mois-de-2022-5.pdf $FILE && echo -e "${BGreen}V.5 ERFOLGREICH${NC}" && echo
fi
...
then
    ...
    mv -v Menu-du-mois-de-2022-4.pdf $FILE && echo -e "${BGreen}V.4 ERFOLGREICH${NC}" && echo
fi
...
then
    ...
    mv -v Menu-du-mois-de-2022-3.pdf $FILE && echo -e "${BGreen}V.3 ERFOLGREICH${NC}" && echo
fi
...
then
    ...
    mv -v Menu-du-mois-de-2022-2.pdf $FILE && echo -e "${BGreen}V.2 ERFOLGREICH${NC}" && echo
fi
...
then
    ...
    mv -v Menu-du-mois-de-2022-1.pdf $FILE && echo -e "${BGreen}V.1 ERFOLGREICH${NC}" && echo
fi
